"""Supabase authentication helpers shared by game API adapters."""

from __future__ import annotations

from werewolf_agent.api.supabase import SupabaseAuthApi, SupabaseSession, SupabaseSessionStore
from werewolf_agent.commons.configuration import AppSettings
from werewolf_agent.commons.shared.messages import MESSAGE_SUPABASE_CLIENT_CONFIG_REQUIRED
...
def _auth_client(settings: AppSettings) -> SupabaseAuthApi:
