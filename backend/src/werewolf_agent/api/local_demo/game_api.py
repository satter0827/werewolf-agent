"""Demo game API that never touches backend API or Supabase."""
...
from werewolf_agent.api.telemetry import LoggingTelemetrySink
from werewolf_agent.api.usecase_bridge import (
...
from werewolf_agent.commons.shared.messages import MESSAGE_GAME_NOT_FOUND, MESSAGE_REVEAL_DISABLED
