...
LOG_PRIVATE_OBSERVATION_RETURNED = "Private observation returned"
LOG_PLAYER_ACTION_SUBMITTED = "Player action submitted"
LOG_CLI_API_REQUEST_COMPLETED = "CLI API request completed"
...
LOG_SHARED_API_REQUEST_COMPLETED = "Public API request completed"
LOG_STREAMLIT_ACTION_SUBMITTED = "Streamlit action submitted"
LOG_STREAMLIT_APPLICATION_ERROR_HANDLED = "Handled Streamlit application error"
LOG_STREAMLIT_CONNECTION_CHECKED = "Streamlit connection checked"
LOG_STREAMLIT_GAME_CREATED = "Streamlit game created"
LOG_STREAMLIT_GAME_STEPPED = "Streamlit game stepped"
LOG_STREAMLIT_REFRESHED = "Streamlit refreshed public data"
...
MESSAGE_JSON_OUTPUT_CANNOT_FOLLOW = "Use jsonl output when following streamed events."
