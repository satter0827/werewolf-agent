...
from werewolf_agent.entrypoint.streamlit.history import (
    build_history_options,
    create_session_game_selection,
)
from werewolf_agent.entrypoint.streamlit.i18n import (
    I18nCatalog,
    Language,
    load_i18n,
)
from werewolf_agent.entrypoint.streamlit.operations import (
...
from werewolf_agent.entrypoint.streamlit.screens import (
    ScreenCatalog,
    ScreenElement,
    load_screen_catalog,
)
from werewolf_agent.entrypoint.streamlit.setup import (
...
from werewolf_agent.entrypoint.streamlit.state import (
    KEY_MESSAGE,
...
from werewolf_agent.entrypoint.streamlit.styles import load_style_tag
...
def main() -> None:
    ...
    configure_entrypoint_logging(settings, service_name=settings.streamlit_service_name)
