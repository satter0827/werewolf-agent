...
HELP_API_URL_WEREWOLF = "Base URL for the Werewolf Agent API."
HELP_API_URL = "Base URL for the API."
...
HELP_MAX_STEPS = "Maximum API step calls."
HELP_LOG_JSONL = "Optional public timeline JSONL."
HELP_POLL_INTERVAL_STEPS = "Seconds to wait between API step calls."
...
HELP_GAME_ID_REPLAY = "Game id to replay from the API."
...
TABLE_TITLE_API_HEALTH = "API Health"
