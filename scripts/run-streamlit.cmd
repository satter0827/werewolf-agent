...
"%PYTHON%" -m streamlit run src/werewolf_agent/interfaces/streamlit/app.py --server.address 127.0.0.1 --server.port %PORT% --server.headless true --browser.gatherUsageStats false
