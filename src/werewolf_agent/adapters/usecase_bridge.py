"""Mapping from runtime settings to use case context."""
...
from werewolf_agent.usecase.models import GameUseCaseConfig


def build_game_usecase_config(settings: AppSettings | None = None) -> GameUseCaseConfig:
    """Return use case configuration from application settings.
    ...
    Returns:
        Use case configuration without entry point-only settings.
