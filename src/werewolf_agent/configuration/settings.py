...
from werewolf_agent.configuration.validation import normalize_choice, normalize_non_blank
...
class AppSettings(BaseSettings):
    ...
    def game_definitions(self) -> GameDefinitions:
        ...
        return load_game_definitions(
            ...
            abilities_path=self.game_abilities_path,
        )
    ...
    def _validate_definition_settings(self) -> None:
        ...
        try:
            ...
            if self.game_default_setup_preset_id not in game_definitions.catalog.setup_presets:
                raise ValueError(message_unknown_setup_preset(self.game_default_setup_preset_id))
            missing_counts = [
                player_count
