...
from werewolf_agent.interfaces.streamlit.components import (
    action_header_html,
    advance_note_html,
    auto_progress_html,
...
from werewolf_agent.interfaces.streamlit.history import (
    build_history_options,
    create_session_game_selection,
)
from werewolf_agent.interfaces.streamlit.i18n import (
    I18nCatalog,
    Language,
    load_i18n,
)
from werewolf_agent.interfaces.streamlit.operations import (
...
from werewolf_agent.interfaces.streamlit.screens import (
    ScreenCatalog,
    ScreenElement,
    load_screen_catalog,
)
from werewolf_agent.interfaces.streamlit.setup import (
...
from werewolf_agent.interfaces.streamlit.state import (
    KEY_MESSAGE,
...
from werewolf_agent.interfaces.streamlit.styles import load_style_tag
