"""Small object-oriented facade for game use cases."""

from __future__ import annotations

from dataclasses import dataclass

import werewolf_agent.usecase.handlers as handlers
...
from werewolf_agent.usecase._replay import verify_replay
...
class GameApplication:
    ...
    def __init__(self, dependencies: UsecaseContext) -> None:
    ...
    def create(
        ...
        command = CreateGameCommand(
            ...
            rules=input.rules or self._dependencies.game_definitions.rules.local_rules,
            ...
            custom_roles=list(input.custom_roles),
            custom_characters=list(input.custom_characters),
