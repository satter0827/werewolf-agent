"""Projections from domain state to use case results."""
...
from werewolf_agent.configuration.constants import DEFAULT_NARRATION_MODE, NARRATION_MODE_NONE
from werewolf_agent.configuration.definitions import NarrationProfileDefinition
from werewolf_agent.configuration.validation import public_generated_player_label
